<div class="hero relative bg-[url('images/common-bg.jpg')] bg-no-repeat bg-cover bg-top pb-16">
    <div class="container mx-auto pt-40 lg:pt-28 flex flex-col lg:flex-row items-center px-5 gap-5">
        ...
        <div class="relative z-30 basis-1/2">
            <h1 class="text-white font-bold text-[40px] leading-tight">
                Evento Start Reserve <span class="text-blue-400">Events</span>
            </h1>
            ...
            <div class="mt-6 flex items-center gap-3 flex-wrap">
                <a href="#"
                   class="py-3 px-4 text-white border-2 border-indigo-600 bg-indigo-600 rounded-md inline-block font-bold text-[15px] transition-all hover:bg-indigo-700 hover:border-indigo-700">Reserve
                    Event Now</a>

            </div>
        </div>
        <div class="image relative w-[25rem] gap-16 z-30">
